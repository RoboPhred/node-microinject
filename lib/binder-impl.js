...
class BinderImpl {
    ...
    to(ctor) {
        ...
        this._ensureCanBind();
        return this._binding = new binding_impl_1.ScopedBindingImpl(this._identifier, context => context.container.create(ctor), ctor);
    }
    toDynamicValue(factory) {
        ...
        this._ensureCanBind();
        return this._binding = new binding_impl_1.ScopedBindingImpl(this._identifier, context => factory(context));
    }
