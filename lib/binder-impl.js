...
class BinderImpl {
    ...
    to(ctor) {
        ...
        this._ensureCanBind();
        return this._binding = new binding_impl_1.ScopedBindingImpl(context => context.container.create(ctor), scope_utils_1.isSingleton(ctor));
    }
    toDynamicValue(factory) {
        ...
        this._ensureCanBind();
        return this._binding = new binding_impl_1.ScopedBindingImpl(context => factory(context));
    }
    toConstantValue(value) {
        this._binding = new binding_impl_1.ScopedBindingImpl(() => value);
    }
