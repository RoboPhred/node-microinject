...
describe("defaultComponentResolvers", function () {
    ...
    describe(".ctor", function () {
        ...
        function invokeResolver(args) {
            const creator = Object.assign({}, partialCtorCreator, { ctorInjections: args.map(arg => ({
        ...
        it("throws on circular dependencies", function () {
            ...
            chai_1.expect(() => component_resolver_1.defaultComponentResolvers.ctor(identifier, classB, stubResolver)).to.throw(errors_1.DependencyResolutionError, /cyclic/);
        });
    });
