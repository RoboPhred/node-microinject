 ...
 */
export declare function inject(identifier: Identifier, opts?: IdentifierInjectionOptions): (target: any, targetKey: string | symbol | undefined, index?: number | undefined) => void;
/**
 ...
 */
export declare function injectParam(paramKey: string | number | symbol, opts?: ParameterInjectionOptions): (target: any, targetKey: string | symbol | undefined, index?: number | undefined) => void;
/**
 ...
 * @param paramName The identifier of the parameter to use.
 */
export declare function injectScope(scope: Scope): (target: any, targetKey: string | symbol | undefined, index?: number | undefined) => void;
